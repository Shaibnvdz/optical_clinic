    ...
    <div class="whole-container">
        ...
        <div class="account-setting-container">
            ...
            <div class="account-setting-sidebar">
                <a href="index.php"><img class="back-arrow" src=".\\imagesfinal\back-arrow.png" alt="" height="20px"></a> 
                <div class="text-position">
                    <a href="account-settings.php"><p id="editprofile">Edit Profile</p></a> 
                    <a href="change-password.php"><p id="changepassword">Change Password</p></a> 
                </div>
